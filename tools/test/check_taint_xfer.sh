...
run_check "xfer_r2r" "taint_xfer_r2r_smoke.c" "taint_xfer_r2r_smoke.exe"
run_check "xfer_m2r" "taint_xfer_m2r_smoke.c" "taint_xfer_m2r_smoke.exe"
run_check "xfer_r2m" "taint_xfer_r2m_smoke.c" "taint_xfer_r2m_smoke.exe"
run_check "xfer_pushpop" "taint_xfer_pushpop_smoke.c" "taint_xfer_pushpop_smoke.exe"
run_check "xfer_stos" "taint_xfer_stos_smoke.c" "taint_xfer_stos_smoke.exe"
run_check "xfer_movbe" "taint_xfer_movbe_smoke.c" "taint_xfer_movbe_smoke.exe"
run_check "xfer_movlph" "taint_xfer_movlph_smoke.c" "taint_xfer_movlph_smoke.exe"
run_check "xfer_lea" "taint_xfer_lea_smoke.c" "taint_xfer_lea_smoke.exe"

printf "All xfer checks passed.\n"
